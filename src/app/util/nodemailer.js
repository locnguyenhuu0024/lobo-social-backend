...
var message = (data) =>  {
            ...
            Xác nhận tài khoản của bạn
                                  ...
                                  <tr>
                                    <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                      Chào <span style="font-weight: bold">${data.name}</span>, để bắt đầu sử dụng tài khoản Lobo, bạn cần xác nhận địa chỉ email của mình.
          </span>
                                  ...
                                  <tr>
                                    <td align="center">
                                      <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">Nếu bạn bỏ qua email này và không xác thực tài khoản. Tài khoản của bạn sẽ bị xoá khỏi hệ thống.</p>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
    ...
    return {
        ...
        to: data.email,
        subject: "Xác nhận email - Lobo Social",
        html: html
    }
};
